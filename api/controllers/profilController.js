...
exports.getPageProfil = (req, res) => {
       ...
       // Server renvoi à l'Utilisateur un fichier Handlebars HTML 'profil' se situant dans le DOSSIER views //
       res.render('profil', {
...
exports.connexionProfil = (req, res) => {
    ...
    // Server permet de rediriger (redirect) l'Utilisateur vers l'URL de la page Handlebars HTML /profil se situant dans le views juste après le remplissage du formulaire de la page LOGIN //
    res.redirect('/profil')
}