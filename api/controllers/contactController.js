...
exports.formContact = (req, res) => {
    ...
    // req.body permet de nous ressortir les données dans un terminal de commande afin de constater du bon fonctionnement de l'applis lors du remplissage des formulaires de contact visionnant les données au moment de la validation //
